# A220 Cockpit Shaking
var shakeEffectA22X = props.globals.initNode("/systems/shake/effect", 0, "BOOL");
var shakeA22X = props.globals.initNode("/systems/shake/shaking", 0, "DOUBLE");
var rSpeed = 0;
var sf = 0;
var n_g_l = 0;
var n_g_r = 0;
